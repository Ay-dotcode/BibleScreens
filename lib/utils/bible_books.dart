...
class BibleBooks {
  static const List<Map<String, dynamic>> _books = [
    ...
    },
    {
      'name': '1 Samuel',
      'api': '1+samuel',
      'aliases': ['1sam', '1sa', '1s', '1sm']
    },
    {
      'name': '2 Samuel',
      'api': '2+samuel',
      'aliases': ['2sam', '2sa', '2s', '2sm']
    },
    {
      'name': '1 Kings',
      'api': '1+kings',
    ...
    },
    {
      'name': '1 Chronicles',
      'api': '1+chronicles',
      'aliases': ['1chr', '1ch', '1chron']
    },
    {
      'name': '2 Chronicles',
      'api': '2+chronicles',
      'aliases': ['2chr', '2ch', '2chron']
    },
    {
      'name': 'Ezra',
      'api': 'ezra',
    ...
    },
    {
      ...
      'api': 'song+of+solomon',
      'aliases': ['song', 'sos', 'ss', 'sg', 'song of songs', 'songs']
    },
    {
      'name': 'Isaiah',
      'api': 'isaiah',
    ...
    },
    {
      ...
      'api': '1+thessalonians',
      'aliases': ['1thess', '1th', '1the']
    },
    {
      'name': '2 Thessalonians',
      'api': '2+thessalonians',
      'aliases': ['2thess', '2th', '2the']
    },
    {
      'name': '1 Timothy',
      'api': '1+timothy',
    ...
    },
    {
      'name': '1 Peter',
      'api': '1+peter',
      'aliases': ['1pet', '1pe', '1pt', '1p']
    },
    {
      'name': '2 Peter',
      'api': '2+peter',
      'aliases': ['2pet', '2pe', '2pt', '2p']
    },
    {
      'name': '1 John',
      'api': '1+john',
      'aliases': ['1jhn', '1jn', '1jo', '1j']
    },
    {
      'name': '2 John',
      'api': '2+john',
      'aliases': ['2jhn', '2jn', '2jo', '2j']
    },
    {
      'name': '3 John',
      'api': '3+john',
      'aliases': ['3jhn', '3jn', '3jo', '3j']
    },
    {
      'name': 'Jude',
      'api': 'jude',
  ...
  /// Canonical books in Bible order.
  static List<String> get canonicalBooks =>
      _books.map((book) => book['name'] as String).toList(growable: false);
}
